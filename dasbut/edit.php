					...
					<nav class="side-menu">
                        ...
                        ?>
                                ...
                                <form method="POST" action="update.php" enctype="multipart/form-data">
																	<input type="hidden"  name="id_wisata" value="<?php echo $kol['id_wisata'] ?>">
                             ...
                             function initialize() {
                               ...
                               google.maps.event.addDomListener(window, 'load', initialize);
                                 ...
                                 <div id="googleMap" style="width:100%;height:380px;"></div>
 															 <br>
																 <button class="btn btn-primary btn-lg btn-block" type="submit" value="update" >Perbarui Data</button>
