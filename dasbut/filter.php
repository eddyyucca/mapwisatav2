 		...
 		<div class="container-fluid">
 			<header class="section-header">
 				<div class="tbl">
 					<div class="tbl-row">
 						<div class="tbl-cell">
 							<h2>Filter Komentar Untuk <?php echo $kol['nm_wisata'] ?></h2>
...
if (tanya == true) return true;
            ...
            $id_wisata = $_GET['id_wisata'];
            // buat query untuk ambil data dari database
            $sql = "SELECT * FROM pengunjung WHERE id_artikel=$id_wisata";
            $query = mysqli_query($koneksi, $sql);
            while ($komentar = mysqli_fetch_array($query)){
            echo   '<tr>';
            echo      '<th>'.$komentar['nama'].' &nbsp</th>';
            echo   '<tr>';
            echo '<td>'.$komentar['komentar'].'</th>';
            echo '<br>';
            echo '<br>';
            echo  '<a class="btn btn-danger" onclick="return konfirmasi()" href="hapuskomentar.php?id_komentar='.$komentar['id_komentar'].'">HAPUS</a>';
            echo '</th>';
            }
             ?>
 					</table>
